  ...
  return (
    <div className={containerClasses}>
      ...
      <div className={styles.inputContainer}>
        ...
        <input id={inputId} ref={inputRef} className={styles.hidden} value={text} aria-placeholder={placeholder} type={type} onFocus={onHandleFocus} onBlur={onHandleBlur} onChange={onHandleChange} onSelect={onHandleSelect} onClick={onHandleClick} onKeyDown={onHandleKeyDown} {...rest} autoComplete={rest.autoComplete || "off"} />
      </div>
    </div>
  );
}
